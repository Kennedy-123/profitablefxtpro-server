...
export const sendEmail = async (to: string, username: string, amount: number, balance: number) => {
  try {
    const mailOptions = {
    ...
    <body>
      <div class="email-container">
        ...
        <div class="content">
          ...
          <a class="button" href="https://yourwebsite.com/dashboard">View Your Account</a>
        </div>
        <div class="footer">
